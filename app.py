...
with col_right:
    if uploaded_file is not None:
        if model_loaded:
            ...
            # AI Disclaimer
            st.markdown("""
            <div style='margin-top: 20px; padding: 14px 18px; background: rgba(239, 68, 68, 0.03); border: 1px solid rgba(239, 68, 68, 0.15); border-radius: 12px; font-size: 0.85rem; color: #94a3b8; line-height: 1.5;'>
                ⚠️ <b>Agronomic AI Disclaimer:</b> This diagnostic report is generated by a deep learning neural network. While engineered for high precision, computer vision classifications are subject to statistical margins of error and should not replace on-site professional agronomic evaluation. Please exercise diligence and cross-reference these guidelines with regional agricultural extension standards prior to executing chemical or intensive treatments.
            </div>
            """, unsafe_allow_html=True)
